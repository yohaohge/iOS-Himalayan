//
//  KFBHorizontalLinearFlowLayout.swift
//  KFBHorizontalLinearFlowLayout
//
...
public class KFBHorizontalLinearFlowLayout: UICollectionViewFlowLayout {
    
    private var lastCollectionViewSize: CGSize = CGSizeZero
    
    public var scalingOffset: CGFloat = 112
    //for offsets >= scalingOffset scale factor is minimumScaleFactor
