...
@synthesize activityLable = _activityLable;
...
- (UILabel *)activityLable
{
    if(!_activityLable)
    {
        _activityLable = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
        _activityLable.text = @"加载中...";
        _activityLable.textColor = [UIColor colorWithRed:161/255.0 green:161/255.0 blue:161/255.0 alpha:1.0];
        _activityLable.font = [UIFont boldSystemFontOfSize:13.0f];
        _activityLable.textAlignment = NSTextAlignmentCenter;
        _activityLable.backgroundColor = [UIColor clearColor];
